...
import ABUserLoggedIn from '@/components/customs/data/Identity/ABUserLoggedIn';
...
const DrawerWrapper: React.FC = ({ children }) => {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* <div className="fixed top-0 z-20 mb-4 flex w-full max-w-md items-center justify-between border-b border-border-200 border-opacity-75 bg-white p-5 md:mb-6"> */}
        <div className='grid content-center pr-1'>
          <Logo className="w-24 h-fit md:w-auto" />
        </div>
      ...
      <div className="pt-[5.8rem]">{children}</div>
