...
export const siteSettings = {
  ...
  // ],
  authorizedLinksMobile: [
    { href:`${ FrontPath.PROFILE_SETTING}/${cookieUser?._id}`, label: 'Profile Settings' },
    { href:`${ FrontPath.MY_POSTS}/${cookieUser?._id}?type=myPosts`, label: 'My Posts' },
    { href:`${FrontPath.DEPARTMENT_POST}/${_.get(cookieUser, 'departmentOnDuty._id')}`, label: 'My Department' },
